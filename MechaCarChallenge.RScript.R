...
> 
  > savehistory("~/Desktop/DataClass/Projects/R_Analysis/Challenge/MechaCarChallenge.RScript.Rhistory")
> library(dplyr)
...
> View(lot_summary)
> save.image("~/Desktop/DataClass/Projects/R_Analysis/Challenge/MechaCarChallenge.RScript.RData")
...
data:  subset(suspension_coil_table$PSI, suspension_coil_table$Manufacturing_Lot == "Lot1")
...
data:  subset(suspension_coil_table$PSI, suspension_coil_table$Manufacturing_Lot == "Lot2")
...
data:  subset(suspension_coil_table$PSI, suspension_coil_table$Manufacturing_Lot == "Lot3")
